...
pinMode(puls1,INPUT ); // Habilita la resistencia pull-down para el pulsador 1

 
 pinMode(buzzerPin, OUTPUT); // Habilita el buzzer como salida
 pinMode(led1, OUTPUT); // Habilita el LED 1 como salida
